...
from api_service.schemas.user import UserModel, UserCreate, UserUpdate
from api_service.services.auth_backend import fastapi_users, auth_backend, current_active_user
